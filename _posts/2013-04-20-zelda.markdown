...
### Animation 4: Background colour

The background starts black, then when the tumbling finishes, briefly flashes white and then green. This colour sequence is timed to coincide with the appearance of the text. The keyframes:
