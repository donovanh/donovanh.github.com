...
All the examples mentioned can be found via [my Codepen account](http://codepen.io/donovanh), or by selecting the "Edit on Codepen" links in each example.
...
We'll need an extra element to contain the 8, as well as some styles to place it on the ball.
    ...
    .ball .eight:before {
      ...
      font-size: 90px;
      line-height: 104px;
      -webkit-transform: skewX(8deg) skewY(2deg);
    }
