...
At this time of year, as we are all busy updating our footer copyright dates, it's an opportunity to look back over the past year and think about what we hope to achieve in the next.
...
It has been a busy year, and I've learned a huge amount. What surprised me more than anything else has been the response to the blog posts. I've had great support from some lovely people, including Zoran at [CSS Weekly](http://css-weekly.com/), Peter at [HTML5 Weekly](http://html5weekly.com/), Mary Lou at [Codrops](http://tympanus.net/codrops/) and loads of people on Twitter.

I've had my blog linked by [Jim Dalrymple](http://www.loopinsight.com/2013/11/13/css-mac-plus/), mentioned by [Zeldman](https://twitter.com/zeldman/status/400759828295217152) and many other wonderful people.

## 2014

I hope 2014 is as good a year. It's off to a great start. While I can't comment on details yet, I'm helping build an interesting website for an event later in the year, and have some blogs to write about CSS transforms and some canvas stuff. If you'd like to hear when these posts go live, [follow me on Twitter](http://twitter.com/donovanh).

Thank you for the support this year, it is much appreciated.
