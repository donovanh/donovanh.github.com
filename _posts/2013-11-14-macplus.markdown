...
Growing up there are some icons, whether they are people, places or even products that stand out in my memory. One of my favourite computing moments was when I first got to use a Mac Plus. In this post I will try to pay tribute to this lovely computer by creating it in CSS.
...
[TODO MEDIA: Either an animated GIF of the animated scene or embedded HTML]
...
I hope you find this article helpful. I can be reached on Twitter as [@donovanh](http://twitter.com/donovanh).
